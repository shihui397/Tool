...
public class ProgressActivity extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        emptyStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_emptyImageHeight, 208);
        ...
        errorStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_errorImageWidth, 200);

        errorStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_errorImageHeight, 200);
        ...
        typedArray.recycle();
//        empty = getResources().getDrawable(R.drawable)
    ...
    private void switchState(String state, Drawable drawable, String errorText, String errorTextContent,
        ...
        switch (state) {
            ...
            case ERROR:
                ...
                errorStateContentTextView.setLines(1);
    ...
    private void setLoadingView() {
        if (loadingStateRelativeLayout == null) {
            ...
            layoutParams = new LayoutParams(60,
                    60);
