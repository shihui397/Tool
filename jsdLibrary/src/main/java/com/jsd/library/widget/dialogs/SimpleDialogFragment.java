 ...
 * IDialogListener} in your Fragment or Activity to rect on positive and negative button clicks. This class can
...
public class SimpleDialogFragment extends BaseDialogFragment {
    ...
    protected final static String ARG_DISMISS_AFTER_ACTION = "dismissAfterAction";

    protected int mRequestCode;

    private IDialogListener dialogListener = null;
    private INeutralDialogListener neutralDialogListener = null;

    private KeyBackListener keyBackListener;

    public interface KeyBackListener {
        boolean keyBack(int keyCode, KeyEvent event);
    }
        ...
        getDialog().setOnKeyListener(new DialogInterface.OnKeyListener() {
            ...
            public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
                if (keyBackListener != null) {
                    return keyBackListener.keyBack(keyCode, event);
                } else {
                    return false;
                }
            }
    ...
    protected BaseDialogFragment.Builder build(BaseDialogFragment.Builder builder) {
        ...
        if (!TextUtils.isEmpty(positiveButtonText)) {
            builder.setPositiveButton(positiveButtonText, new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    IDialogListener listener = getDialogListener();
                    if (listener != null) {
        ...
        if (!TextUtils.isEmpty(neutralButtonText)) {
            builder.setNeutralButton(neutralButtonText, new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    INeutralDialogListener listener = getNeutralDialogListener();
                    if (listener != null) {
    ...
    protected boolean isDismissAfterAction() {
        return getArguments().getBoolean(ARG_DISMISS_AFTER_ACTION, true);
    }
    ...
    protected IDialogListener getDialogListener() {
        ...
        if (targetFragment != null) {
            if (targetFragment instanceof IDialogListener) {
                return (IDialogListener) targetFragment;
            }
        } else {
            if (getActivity() instanceof IDialogListener) {
                return (IDialogListener) getActivity();
            }
        }
        return null;
    }

    public void setNeutralDialogListener(INeutralDialogListener iNeutralDialogListener) {
        this.neutralDialogListener = iNeutralDialogListener;
    }

    protected INeutralDialogListener getNeutralDialogListener() {
        if (neutralDialogListener != null) {
            return neutralDialogListener;
        }
        final Fragment targetFragment = getTargetFragment();
        if (targetFragment != null) {
            if (targetFragment instanceof INeutralDialogListener) {
                return (INeutralDialogListener) targetFragment;
            }
        } else {
            if (getActivity() instanceof INeutralDialogListener) {
                return (INeutralDialogListener) getActivity();
            }
        }
        return null;
    }
    ...
    public static class SimpleDialogBuilder extends BaseDialogBuilder<SimpleDialogBuilder> {
        ...
        public SimpleDialogBuilder setPositiveButton(String text, final View.OnClickListener listener) {
        ...
        public SimpleDialogBuilder setNegativeButton(String text, final View.OnClickListener listener) {
