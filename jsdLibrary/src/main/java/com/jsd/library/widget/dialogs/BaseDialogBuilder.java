...
public abstract class BaseDialogBuilder<T extends BaseDialogBuilder<T>> {
    ...
    public final static String ARG_DISMISS_AFTER_ACTION = "dismissAfterAction";
    ...
    public T setDismissAfterAction(boolean dismiss) {
        mDismissAfterAction = dismiss;
        return self();
    }
    ...
    private BaseDialogFragment create() {
        ...
        args.putBoolean(ARG_DISMISS_AFTER_ACTION, mDismissAfterAction);
