 ...
 * {@link #createBuilder(Context, FragmentManager)}
 * .
 * </p>
 * <p>
 * Dialog can be cancelable - to listen to cancellation, activity or target
 * fragment must implement
 * {@link ISimpleDialogCancelListener}
 * </p>
 * 
...
public class IconDialogFragment extends BaseDialogFragment {
	...
	protected final static String IMAGEICON = "iamge";
	...
	protected Builder build(Builder builder) {
		final int defaultMessageTextColor = getResources().getColor(R.color.sdl_message_text_white);
		...
		final ImageView imgProgress = (ImageView) view.findViewById(R.id.sdl__progress);
		imgProgress.setImageResource(getArguments().getInt(IMAGEICON));
	...
	public static class ProgressDialogBuilder extends BaseDialogBuilder<ProgressDialogBuilder> {
		...
		protected ProgressDialogBuilder(Context context, FragmentManager fragmentManager) {
			super(context, fragmentManager, IconDialogFragment.class);
		}
		...
		public ProgressDialogBuilder setImageResource(int ImageResourceId) {
		...
		protected Bundle prepareArguments() {
			...
			args.putInt(IMAGEICON, mImageResource);
