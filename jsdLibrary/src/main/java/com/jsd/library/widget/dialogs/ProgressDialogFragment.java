 ...
 * <p>
 * To show the dialog, start with {@link #createBuilder(Context, FragmentManager)}.
 * </p>
 * <p>
...
public class ProgressDialogFragment extends BaseDialogFragment {
    ...
    protected Builder build(Builder builder) {
        final int defaultMessageTextColor = getResources().getColor(R.color.sdl_message_text_gray);
        ...
        final View imgProgress = view.findViewById(R.id.sdl__progress);
        if (imgProgress instanceof MovieView){
            Gif gif = new Gif(R.drawable.loading, Gif.MODE_REPEAT, Integer.MAX_VALUE);
            ((MovieView)imgProgress).setMovie(gif);
            ((MovieView)imgProgress).startMovie();
        }else {
            imgProgress.setAnimation(AnimationUtils.loadAnimation(getActivity(), R.anim.sdl_loading));
        }
